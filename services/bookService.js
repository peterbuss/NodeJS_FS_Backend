...
exports.getAllBooks = async (req, res) => {
    try {
        ...
        return errorTemplate(res, e, messages.books_not_found, 500);
    }
};
...
exports.getAllBooksIds = async (req, res) => {
    try {
        ...
        //order of routes in bookRouter.js can cause problems
        console.log('books', books);
        return res.status(200).json({
            message: messages.books_found,
            books: books,
...
exports.postBook = async (req, res) => {
    try {
        ...
        let foundBook = Object.assign({}, req.body);
